    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <Input
          ...
          required={required}
          className={`flex-1 ${isAutoGenerated ? 'border-amber-300 bg-amber-50 focus-visible:ring-amber-200' : ''}`}
          title={isAutoGenerated ? 'Auto-populated certificate number. You can edit it if needed.' : undefined}
        />
        <Button
          type="button"
          variant="outline"
      ...
      {isAutoGenerated && (
        <p
          ...
          title="This value was automatically generated to reduce repeated data entry."
        >
          Auto-populated from the certificate numbering pattern. Hover the field for details.
        </p>
      )}
    </div>
  );
