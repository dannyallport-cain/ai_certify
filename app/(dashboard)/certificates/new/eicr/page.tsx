...
const EDITOR_CARD_CLASS = 'overflow-hidden rounded-none border-[#c28d93] py-0 shadow-none';
const EDITOR_HEADER_CLASS = 'border-b border-[#9d6f75] bg-[#b98288] px-4 py-2 text-white [&_[data-slot=card-title]]:text-[13px] [&_[data-slot=card-title]]:font-semibold [&_[data-slot=card-title]]:uppercase [&_[data-slot=card-title]]:tracking-[0.06em] [&_[data-slot=card-description]]:text-[11px] [&_[data-slot=card-description]]:leading-4 [&_[data-slot=card-description]]:text-rose-50/90';
const EDITOR_CONTENT_CLASS = 'p-0 [&_label]:text-[10px] [&_label]:font-semibold [&_label]:uppercase [&_label]:tracking-[0.05em] [&_label]:text-slate-700 [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:h-8 [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:rounded-none [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:border-slate-300 [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:bg-white [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:px-2 [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:text-xs [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:shadow-none [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:focus-visible:ring-1 [&_input:not([type=radio]):not([type=checkbox]):not([type=hidden])]:focus-visible:ring-[#b98288]/20 [&_[data-slot=textarea]]:rounded-none [&_[data-slot=textarea]]:border-slate-300 [&_[data-slot=textarea]]:bg-white [&_[data-slot=textarea]]:px-2 [&_[data-slot=textarea]]:py-1.5 [&_[data-slot=textarea]]:text-xs [&_[data-slot=textarea]]:leading-4 [&_[data-slot=textarea]]:shadow-none [&_[data-slot=textarea]]:focus-visible:ring-1 [&_[data-slot=textarea]]:focus-visible:ring-[#b98288]/20 [&_[role=combobox]]:h-8 [&_[role=combobox]]:rounded-none [&_[role=combobox]]:border-slate-300 [&_[role=combobox]]:bg-white [&_[role=combobox]]:px-2 [&_[role=combobox]]:pr-8 [&_[role=combobox]]:text-left [&_[role=combobox]]:text-xs [&_[role=combobox]]:shadow-none [&_[role=combobox]]:focus:ring-1 [&_[role=combobox]]:focus:ring-[#b98288]/20 [&_[role=combobox]]:focus:ring-offset-0 [&_[role=combobox]>span]:truncate [&_[role=combobox]>svg]:ml-2 [&_[role=combobox]>svg]:h-4 [&_[role=combobox]>svg]:w-4 [&_[role=combobox]>svg]:shrink-0 [&_[role=combobox]>svg]:opacity-70';
...
const EDITOR_NATIVE_INPUT_CLASS = 'flex h-8 w-full rounded-none border border-slate-300 bg-white px-2 text-xs shadow-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-[#b98288]/20';
...
export function EICRCertificatePage({ streamlined = false }: { streamlined?: boolean } = {}) {
  ...
  const clientAddressTouchedRef = useRef(false);
  const installationAddressTouchedRef = useRef(false);
