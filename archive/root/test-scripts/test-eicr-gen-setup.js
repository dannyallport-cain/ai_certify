// Test the actual EICR PDF generator with sample data
const path = require('path');

// We need to use tsx to run TypeScript
const { execSync } = require('child_process');

// Create an inline TS test
const tsCode = `
...
const fs = require('fs');
fs.writeFileSync('test-eicr-gen.ts', tsCode);
console.log('Test TS file written. Run with: npx tsx test-eicr-gen.ts');
